...
class TestWidgetsHistoricUrls:
    """Testing class for :py:mod:`widgets.inhouse.historic.urls` module."""
    ...
    def test_widgets_inhouse_historic_urls_historic(self):
        ...
        assert url.lookup_str == "widgets.inhouse.historic.views.HistoricView"
    ...
    def test_widgets_inhouse_historic_urls_historic_reset(self):
        ...
        assert isinstance(url, URLPattern)
        assert url.lookup_str == "widgets.inhouse.historic.views.HistoricResetView"
